...
import me.dayler.nuevatel.ai.ami.action.LogoffAction;
 ...
 * @author asalazar
 */
class AmiServiceImpl implements AmiService {
    ...
    public void offerEvent(AmiEventArgs eventArgs) throws OperationException {
        Parameters.checkNull(eventArgs, "eventArgs");
